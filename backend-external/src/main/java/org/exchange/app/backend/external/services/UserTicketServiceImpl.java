...
public class UserTicketServiceImpl implements UserTicketService {
  ...
  @Override
  public void saveTicket(Long idUser, KafkaOrderTicket kafkaOrderTicket) {

    log.info(kafkaOrderTicket);
    inputRecordProducer.sendMessage(kafkaOrderTicket, kafkaOrderTicket.getPair());
  }

...
export class ApiService {
  ...
  public loadTransactionsPdfDocument(
    transactionsPdfRequest: TransactionsPdfRequest,
  ): Observable<Blob> {
    return this.adminReportsService.loadTransactionsPdfDocument(
  ...
  public loadPairPeriodReport(pair: Pair, period: number): Observable<PairPeriodResponse> {
    return this.adminReportsService.loadPairPeriodReport(pair, period);
  }

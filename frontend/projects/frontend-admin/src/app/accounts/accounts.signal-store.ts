  ...
  withMethods(
    (
      ...
      clearBankAccounts: rxMethod<void>(
        pipe(tap(() => patchState(store, { userBankAccounts: [] }))),
      ),
      setSelectedUserId: rxMethod<string | null>(
        pipe(
          tap((selectedUserId) =>
            patchState(store, {
              selectedUserId,
      ...
      setSelectedUserAccountId: rxMethod<string | null>(
        pipe(
          tap((selectedUserAccountId) =>
            patchState(store, {

...
public class UserTicketStatusUtilsTest {
  ...
  @Test
  public final void toObject_should_getCorrectUserTicketStatus_when_inputIsCorrectByteArray() {
  ...
  @Test
  public final void toObject_should_returnNullUserTicketStatus_when_inputIsNULL_BYTE() {
    assertThat(userTicketStatusUtils.toObject(new ByteArrayData(new byte[]{NULL_BYTE}))).isNull();

  }

  @Test
  public final void toByteArray_should_returnNULL_BYTE_when_inputIsNullUserTicketStatus() {

...
class UserMapperTest {
  ...
  @Test
  void toEntity_should_setUserEntityFields_when_methodCalled() {
    User user = new User();
  ...
  @Test
  void toDto_should_setUserFields_when_methodCalled() {
  ...
  @Test
  void updateWithDto_should_updateEmail_when_methodCalled() {
    UserEntity userEntity = new UserEntity();
